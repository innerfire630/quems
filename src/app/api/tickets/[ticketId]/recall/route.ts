// =============================================================================
// POST /api/tickets/[ticketId]/recall — Recall endpoint (2.3.1)
// =============================================================================
...
export const POST = withPermission(async (req: Request) => {
  try {
    ...
    const bodyResult = recallTicketSchema.safeParse(body);
    ...
    // Recall the ticket
    const result = await recallTicket(
    ...
    if (process.env.NODE_ENV !== 'production') {
      console.error('[recall] Unhandled error:', e);
    }
