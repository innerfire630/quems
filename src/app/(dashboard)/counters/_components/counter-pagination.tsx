// =============================================================================
// src/app/(dashboard)/counters/_components/counter-pagination.tsx — Pagination (2.1.2)
// =============================================================================
...
interface CounterPaginationProps {
  page: number;
  totalPages: number;
  search?: string;
  isActive?: string;
...
export function CounterPagination({ page, totalPages, search, isActive }: CounterPaginationProps) {
